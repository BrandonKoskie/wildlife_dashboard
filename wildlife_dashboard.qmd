...
format: dashboard
---
The Hawaiian Monk Seal Entanglement dataset documents reported cases where monk seals became hooked or entangled in fishing gear across the Hawaiian Islands. Each record includes when and where the incident occurred, the type of gear involved, injury severity, and information about the affected seal. The dataset is used to track threats from fishing activity, identify high-risk locations, and support conservation and response efforts by NOAA and partner agencies.
