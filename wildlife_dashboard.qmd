...
format: dashboard
---
The Hawaiian Monk Seal Entanglement data set documents reported cases where monk seals became hooked or entangled in fishing gear across the Hawaiian Islands. Each record includes when and where the incident occurred, the type of gear involved, injury severity, and information about the affected seal. The data set is used to track threats from fishing activity, identify high-risk locations, and support conservation and response efforts by NOAA and partner agencies.

Data link: <https://catalog.data.gov/dataset/hmsrp-hawaiian-monk-seal-entanglement-data1> 
...
### Timeline of Monk Seal Injuries {width=0.5, height=450}

```{r, echo=FALSE, fig.width=8, fig.height=6}
injuries_per_year <- monk_injuries %>%
  count(year)

ggplot(injuries_per_year, aes(year, n)) +
...
```
### Sex Distribution {width=0.5, height=450}

```{r, echo=FALSE, fig.width=8, fig.height=6}
# Extract sex (your original rules)
monk_injuries <- monk_injuries %>%
...
# Keep correct slice order
sex_summary$sex <- factor(
  sex_summary$sex,
...
### Map of Injury Locations {width=0.7, height=700}
